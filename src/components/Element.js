...
const Element = ({onChangeBubblePosition, onActivateAnimation, rotation, animation}) => {
    const tooltipChoice = !animation ? "Active" : "Désactive"
    return (
    <div className="element">
        ...
        <ReactTooltip id="tooltipAnimation" effect="solid" place="bottom" >
            {tooltipChoice} l'animation du BubbleTea.
        </ReactTooltip>
