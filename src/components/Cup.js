...
const Cup = ({color}) => (
    <React.Fragment>
    <g id="background">
        <path fill={color} className="animation-cup" opacity="0.52" d="M19.5,50c1.4-7.1,4.4-13.9,8.8-19.7c2.9-3.8,6.3-7.2,10.2-10.1c8.2-5.9,17.9-9.1,28.1-9.1
    ...
    <g id="border">
        <path fill="none" className="animation-cup" stroke={color} strokeWidth="2.1561" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10" d="
